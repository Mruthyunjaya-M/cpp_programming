...
void test5()
{
    ...
    std::array<int, 5> arr1{42, 52345, 543, 53, -9}; // double {{ }} is C++ 11

    // std::array<int, 5>::iterator min_num = std::min_element(arr1.begin(), arr1.end());
    int *min_num = std::min_element(arr1.begin(), arr1.end());
...
void test6()
{
    ...
    std::array<int, 9> arr1{2, 1, 8, 1, 9, 3, 5, 3, 5}; // double {{ }} is C++ 11
